  ...
  return (
    <Article>
      ...
      <ContentText fontFamily="Roboto Slab, serif" fontStyle="italic">
        Hidetoshi Mitsuzaki takes up symbols, pictograms, infographics and other
        communication design elements in his painting, detaches them from their
        original context and combines them to create his own visual language and
        a space for interpretation.
      </ContentText>
      ...
      <BioContent
        year="2009 - 2013"
        text="Bachelor in Fine Arts at the Kyoto University of Art and Design, Japan"
      ></BioContent>
      <BioContent year="2013" text="moves to Germany"></BioContent>
      <BioContent
        year="2014 - 2021"
        text="Diploma in Fine Arts at the Kunstakademie Duesseldorf, Germany"
      ></BioContent>
      <BioContent
        year="2021"
        text="Master scholar under Prof. Thomas Scheibitz, Kunstakademie Duesseldorf"
      ></BioContent>
      <BioContent
      ...
      <Container maxW="container.sm">
        <HStack mt={7} spacing="20px">
          <LinkItem href="mailto: thornbeam@posteo.eu" textAlign="center">
            Email Thornbeam
          </LinkItem>
          <LinkItem href="/impressum" textAlign="center">
