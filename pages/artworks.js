...
export default function Artworks() {
  return (
    <Article title="Artworks">
      ...
      <ModalImageContainer src="/artworks/2021-skull.png" maxW="100%" maxH="50vh">
        Skull 2021, 100 * 130cm
      </ModalImageContainer>
      <ModalImageContainer src="/artworks/2021-bang_01.png" maxW="80%" maxH="60vh">
        Bang (part 1) 2021, 130 * 100cm
      </ModalImageContainer>
      <ModalImageContainer src="/artworks/2021-bang_02.png" maxW="80%" maxH="60vh">
        Bang (part 2) 2021, 130 * 100cm
      </ModalImageContainer>
      <ModalImageContainer src="/artworks/2020-abd.png" maxW="80%" maxH="60vh">
        A.B.D**** 2020, 180 × 130cm
      </ModalImageContainer>
      <ModalImageContainer id="small" src="/artworks/2020-bjt.png" maxW="40%" maxH="40vh">
        BJT 2020, 50 * 50cm
      </ModalImageContainer>
    </Article>
  );
